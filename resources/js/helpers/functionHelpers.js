...
const FunctionHelpers = {
    install(Vue) {
        ...
        Vue.prototype.$uploadFiles = async function (files, document = null) {
            ...
            if (store.getters.filesInQueueTotal == 0) this.$handleUploading(store.getters.fileQueue[0], document)
        ...
        Vue.prototype.$handleUploading = async function (item, document = null) {
            // Create ceil
            ...
            do {
                ...
                formData.set('tipo_id', parseInt(document))
