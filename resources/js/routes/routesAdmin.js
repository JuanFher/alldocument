const routesAdmin = [
    {
        ...
        children: [
            ...
            },
            {
                ...
                component: () => import(/* webpackChunkName: "chunks/users" */ '../views/Admin/Documents'),
                meta: {
                    requiresAuth: true,
                    title: 'routes_title.documents_list',
                },
            },
            {
                name: 'DocumentCreate',
                path: '/admin/document/create',
                component: () => import(/* webpackChunkName: "chunks/user-create" */ '../views/Admin/Documents/DocumentsCreate'),
                meta: {
                    requiresAuth: true,
            ...
            
            {
                ...
                component: () => import(/* webpackChunkName: "chunks/user" */ '../views/Admin/Documents/Document'),
                meta: {
                    requiresAuth: true,
                    title: 'routes_title.documents_document',
                },
                children: [
                    {
                        name: 'DocumentDelete',
                        path: '/admin/document/:id/delete',
                        component: () =>
                            import(
                                /* webpackChunkName: "chunks/user-delete" */ '../views/Admin/Documents/DocumentTabs/DocumentDelete'
                            ),
                        meta: {
                            requiresAuth: true,
                    ...
                    {
                        name: 'DocumentDetail',
                        path: '/admin/document/:id/details',
                        component: () =>
                            import(
                                /* webpackChunkName: "chunks/user-detail" */ '../views/Admin/Documents/DocumentTabs/DocumentDetail'
                            ),
                        meta: {
                            requiresAuth: true,
                            title: 'detail',
