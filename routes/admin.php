...
use App\Documents\Controllers\DocumentController;
...
Route::get('/campos/{id}', [DocumentController::class, 'getCampos']);
Route::get('/files/{string?}/{tipo?}/{status?}', [DocumentController::class, 'searchFile']);
Route::post('/meta-data', [DocumentController::class, 'insertMetaData']);

Route::apiResource('/pages', AdminPagesController::class);
Route::apiResource('/users', UserController::class);
Route::delete('/documents/{document}/delete', [DocumentController::class, 'destroy']);
